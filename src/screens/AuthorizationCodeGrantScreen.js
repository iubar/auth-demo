...
class AuthorizationCodeGrantScreen extends React.Component {
  ...
  authCodeGrant2 = async () => {
    ...
    this.state.data_to_send_printable =
      "AuthSession.startAsync({authUrl: " + url + "})";
          ...
          {!this.state.screen_disabled && (
            <View>
              ...
              <View style={styles.centered}>
                ...
                <Caption>
                  Quando non utilizzo PKCE devo impostare obbligoriamete un
                  valore per il parametro client_secret. Pertanto solo i client
                  7 e 10 sono compatibili con la modalità PKCE = false.
                </Caption>
              </View>
              <Divider style={{ marginVertical: 20 }} />
              ...
              {warning && (
                <Paragraph theme={{ colors: { text: "red" } }}>
                  {warning}
                </Paragraph>
              )}
