...
class SettingsScreen extends React.Component {
	...
	saveDataInStore = async () => {
		...
		await this.store.saveTokens(this.context.access_token, this.context.refresh_token, this.context.expires_in);
	};
		...
		return (
			<View>
				<ScrollView style={{ paddingHorizontal: 20 }}>
					...
					<Divider style={{ marginVertical: 5 }} />
					<Button style={{ marginHorizontal: 20, marginVertical: 20 }} mode="contained" onPress={this.readDataFromStore}>
						Load data
					</Button>
					<Button
					...
					<Button style={{ marginHorizontal: 20, marginVertical: 20 }} mode="contained" onPress={this.clearDataFromStore}>
						Clear data
					</Button>
